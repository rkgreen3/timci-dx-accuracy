...
df_og <- read.csv("C:/Users/rgreen/Box/3_Output 3/Hybrid study/Diagnostic accuracy study/Analysis/dx-accuracy-data_2024-01-23.csv") #update file path to local machine
...
df <- subset(df, is.na(df$exclude_data_rsn)) #remove requested withdrawals, insufficient data, and other, N = 98
...
write.csv(df, "C:/Users/rgreen/Box/3_Output 3/Hybrid study/Diagnostic accuracy study/Analysis/dx-accuracy-data_clean_2024-01-23.csv")

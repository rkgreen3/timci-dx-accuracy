...
df$m2_index_temp_f <- ifelse(df$m1_index_temp>40, df$m2_index_temp, NA)
df$m2_index_temp <- ifelse(df$m1_index_temp>40, ((df$m2_index_temp_f-32) * (5/9)), df$m2_index_temp)
df$m3_index_temp_f <- ifelse(df$m1_index_temp>40, df$m3_index_temp, NA)
df$m3_index_temp <- ifelse(df$m1_index_temp>40, ((df$m3_index_temp_f-32) * (5/9)), df$m3_index_temp)

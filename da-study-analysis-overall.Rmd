...
filename <- "C:/Users/rgreen/Box/3_Output 3/Hybrid study/Diagnostic accuracy study/Analysis/dx-accuracy-data_clean_2024-01-19.csv"
...
factorVars <- c("age_cat", "sex","cg_relationship", 
                ...
                "tx_other", "mean_ref_o2_abnorm", "mean_ref_pr_abnorm", "mean_ref_temp_abnorm", "mean_ref_pi_abnorm")
...
myVars <- c("age_cat", "sex","cg_relationship", 
            ...
            "dx_fever", "dx_measles", "dx_earinfection", "dx_throatinfection", "dx_other",
            "received_tx", "tx_antibiotic", "tx_antimalarial", "tx_dehydration", "tx_bronchodilator",
            "tx_other", "height", "weight", "muac", "head_circumference", "hemocue_hb", "mean_ref_o2_abnorm", "mean_ref_pr_abnorm", "mean_ref_temp_abnorm", "mean_ref_pi_abnorm")
...
t1lab <- c("N", "Age Category (%)", "0-1 month", "2-11 months", "12-59 months", "Sex = Male/Female (%)",
            "Relationship of caregiver to child (%)", "Community member", "Father only", "Grandfather only", "Grandmother only", "Mother and father", "Mother and grandmother", "Mother only", "Other", "Other family   
             ...
             facility (%)", "Cough (%)", "Difficulty/Rapid breathing (%)", "Fever (%)", "Diarrhea (%)", "Vomiting (%)", "Other (%)", "Received Diagnosis (%)", "Dehydration", "Respiratory", "Digestive", "Malaria", 
              "Fever", "Measles=False", "Ear infection", "Throat infection", "Other", "Received Treatment (%)", "Antibiotic", "Antimalarial", "Dehydration", "Bronchodilator", "Other", "Height (cm) (mean (SD))", 
            "Weight (kg) (mean (SD))", "MUAC (cm) (mean (SD))", "Head Circumference (cm) (mean (SD))", "Hemocue (g/dL) (mean (SD))", "Abnormal SpO2 (reference) (%)", "Abnormal Pulse Rate (reference) (mean (SD))",  
...
t1 <- kable(t1_overall) %>%
  ...
  pack_rows("Physical Characteristics", 45, 48) %>%
  pack_rows("Reference Measurements", 49, 53)
```
`r t1`

...
df_og$m1_ref_index_pres_tachy59mo_tri <- ifelse(!is.na(df_og$m1_ref_tachycardic_tri_59mo) & !is.na(df_og$m1_index_tachycardic_59mo_tri), 1, 0)
...
```{r}
# Long format (overall)
confusion_matrix(df_radg_cat1_l,"ref_hypoxic_tri","index_hypoxic_tri","*0-1 month*")
confusion_matrix(df_radg_cat2_l,"ref_hypoxic_tri","index_hypoxic_tri", "*2-11 months*")
confusion_matrix(df_radg_cat3_l,"ref_hypoxic_tri","index_hypoxic_tri","*12-59 months*")
```

### Fever
```{r}
# Long format (overall)
confusion_matrix(df_radg_cat1_l,"ref_fever_tri","index_fever_tri", "*0-1 month*")
confusion_matrix(df_radg_cat2_l,"ref_fever_tri","index_fever_tri", "*2-11 months*")
confusion_matrix(df_radg_cat3_l,"ref_fever_tri","index_fever_tri","*12-59 months*")
```

### Fast Breathing
```{r}
# Long format
confusion_matrix(df_radg_cat1fb_l,"ref_fastbreath_12mo_tri","index_fastbreath_12mo_tri", "*0-1 month*")
confusion_matrix(df_radg_cat2fb_l,"ref_fastbreath_12mo_tri","index_fastbreath_12mo_tri", "*2-11 months*")
confusion_matrix(df_radg_cat3fb_l,"ref_fastbreath_35mo_tri","index_fastbreath_35mo_tri", "*12-35 months*")
confusion_matrix(df_radg_cat4fb_l,"ref_fastbreath_59mo_tri","index_fastbreath_59mo_tri", "*36-59 months*")
```

### Tachycardia
```{r}
# Long
confusion_matrix(df_radg_cat1_l,"ref_tachycardic_12mo_tri","index_tachycardic_12mo_tri", "*0-1 month*")
confusion_matrix(df_radg_cat2_l,"ref_tachycardic_12mo_tri","index_tachycardic_12mo_tri", "*2-11 months*")
confusion_matrix(df_radg_cat3_l,"ref_tachycardic_59mo_tri","index_tachycardic_59mo_tri", "*12-59 months*")
```
...
### Hypoxia
```{r}
confusion_matrix(df_bio_cat1_l,"ref_hypoxic_tri","index_hypoxic_tri","*0-1 month*")
confusion_matrix(df_bio_cat2_l,"ref_hypoxic_tri","index_hypoxic_tri", "*2-11 months*")
confusion_matrix(df_bio_cat3_l,"ref_hypoxic_tri","index_hypoxic_tri","*12-59 months*")
```

### Fast Breathing
```{r}
confusion_matrix(df_bio_cat1fb_l,"ref_fastbreath_12mo_tri","index_fastbreath_12mo_tri", "*0-1 month*")
confusion_matrix(df_bio_cat2fb_l,"ref_fastbreath_12mo_tri","index_fastbreath_12mo_tri", "*2-11 months*")
confusion_matrix(df_bio_cat3fb_l,"ref_fastbreath_35mo_tri","index_fastbreath_35mo_tri", "*12-35 months*")
confusion_matrix(df_bio_cat4fb_l,"ref_fastbreath_59mo_tri","index_fastbreath_59mo_tri", "*36-59 months*")
```

### Tachycardia
```{r}
confusion_matrix(df_bio_cat1_l,"ref_tachycardic_12mo_tri","index_tachycardic_12mo_tri", "*0-1 month*")
confusion_matrix(df_bio_cat2_l,"ref_tachycardic_12mo_tri","index_tachycardic_12mo_tri", "*2-11 months*")
confusion_matrix(df_bio_cat3_l,"ref_tachycardic_59mo_tri","index_tachycardic_59mo_tri", "*12-59 months*")
```
...
### Hypoxia
```{r}
confusion_matrix(df_neo_cat1_l,"ref_hypoxic_tri","index_hypoxic_tri","*0-1 month*")
confusion_matrix(df_neo_cat2_l,"ref_hypoxic_tri","index_hypoxic_tri", "*2-11 months*")
confusion_matrix(df_neo_cat3_l,"ref_hypoxic_tri","index_hypoxic_tri","*12-59 months*")
```

### Fever
```{r}
confusion_matrix(df_neo_cat1_l,"ref_fever_tri","index_fever_tri", "*0-1 month*")
confusion_matrix(df_neo_cat2_l,"ref_fever_tri","index_fever_tri", "*2-11 months*")
confusion_matrix(df_neo_cat3_l,"ref_fever_tri","index_fever_tri","*12-59 months*")
```

### Fast Breathing
```{r}
confusion_matrix(df_neo_cat1fb_l,"ref_fastbreath_12mo_tri","index_fastbreath_12mo_tri", "*0-1 month*")
confusion_matrix(df_neo_cat2fb_l,"ref_fastbreath_12mo_tri","index_fastbreath_12mo_tri", "*2-11 months*")
confusion_matrix(df_neo_cat3fb_l,"ref_fastbreath_35mo_tri","index_fastbreath_35mo_tri", "*12-35 months*")
confusion_matrix(df_neo_cat4fb_l,"ref_fastbreath_59mo_tri","index_fastbreath_59mo_tri", "*36-59 months*")
```

### Tachycardia
```{r}
confusion_matrix(df_neo_cat1_l,"ref_tachycardic_12mo_tri","index_tachycardic_12mo_tri", "*0-1 month*")
confusion_matrix(df_neo_cat2_l,"ref_tachycardic_12mo_tri","index_tachycardic_12mo_tri", "*2-11 months*")
confusion_matrix(df_neo_cat3_l,"ref_tachycardic_59mo_tri","index_tachycardic_59mo_tri", "*12-59 months*")
```
...
### Hypoxia
```{r}
confusion_matrix(df_onyx_cat3_l,"ref_hypoxic_tri","index_hypoxic_tri","*12-59 months*")
```

### Fast Breathing
```{r}
confusion_matrix(df_onyx_cat3fb_l,"ref_fastbreath_35mo_tri","index_fastbreath_35mo_tri", "*12-35 months*")
confusion_matrix(df_onyx_cat4fb_l,"ref_fastbreath_35mo_tri","index_fastbreath_59mo_tri", "*36-59 months*")
```
...
```{r}
# Long
confusion_matrix(df_scan_cat3_l,"ref_hypoxic_tri","index_hypoxic_tri","*12-59 months*")
```

### Fever
```{r}
confusion_matrix(df_scan_cat3_l,"ref_fever_tri","index_fever_tri","*12-59 months*")
```

### Fast Breathing
```{r}
confusion_matrix(df_scan_cat3fb_l,"ref_fastbreath_35mo_tri","index_fastbreath_35mo_tri", "*12-35 months*")
confusion_matrix(df_scan_cat4fb_l,"ref_fastbreath_59mo_tri","index_fastbreath_59mo_tri", "*36-59 months*")
```

### Tachycardia
```{r}
confusion_matrix(df_scan_cat3_l,"ref_tachycardic_59mo_tri","index_tachycardic_59mo_tri", "*12-59 months*")
```

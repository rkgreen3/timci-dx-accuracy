...
t1lab <- c("N", "Age Category (%)", "0-1 month", "2-11 months", "12-59 months", "Sex = Male/Female (%)",
            ...
            "Weight (kg) (mean (SD))", "MUAC (cm) (mean (SD))", "Head Circumference (cm) (mean (SD))", "Hemocue (g/dL) (mean (SD))", "SpO2 (reference) (mean (SD))", "Pulse Rate (reference) (mean (SD))",  "Temperature 
              (reference) (mean (SD))", "Profusion Index (reference) (mean (SD))")
